...
public class CameraModule extends ReactContextBaseJavaModule {
  ...
  public void pausePreview(final int viewTag) {
    ...
    CameraUIBlock uiBlock = new CameraUIBlock(viewTag, cameraView -> {
      try {
  ...
  public void checkIfRecordAudioPermissionsAreDefined(final Promise promise) {
    try {
      PackageInfo info = getCurrentActivity().getPackageManager()
          .getPackageInfo(getReactApplicationContext().getPackageName(), PackageManager.GET_PERMISSIONS);
  ...
  public void hasTorch(final Promise promise) {
    promise.resolve(
        getReactApplicationContext().getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_FLASH));
  }
